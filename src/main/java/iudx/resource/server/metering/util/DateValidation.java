...
public class DateValidation {
  ...
  public Time dateParamCheck(String start, String end) {
    ...
    try {
      ...
      throw new DxRuntimeException(
          HttpStatusCode.BAD_REQUEST.getValue(), ResponseUrn.BAD_REQUEST_URN, INVALID_DATE_TIME);
    }
  ...
  private long zonedDateTimeMinuteDifference(ZonedDateTime startTime, ZonedDateTime endTime) {
    LOGGER.info(
        "zonedDateTimeMinuteDifference : {}", ChronoUnit.MINUTES.between(startTime, endTime));
