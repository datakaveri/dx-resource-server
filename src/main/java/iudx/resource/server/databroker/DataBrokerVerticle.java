...
public class DataBrokerVerticle extends AbstractVerticle {
    ...
    public void start() throws Exception {
        ...
        iudxInternalRabbitMqClient.start().onSuccess(
        ...
        dataBrokerService =
                new DataBrokerServiceImpl(rabbitClient, amqpUrl, amqpPort, cacheService, iudxInternalVhost,prodVhost,externalVhost);
        ...
        RmqListeners revokeQlistener = new RevokeClientQlistener(vertx, cacheService, rabbitMQOptions, internalVhost);
        ...
        consumer =
                binder.setAddress(DATA_BROKER_SERVICE_ADDRESS).register(DataBrokerService.class, dataBrokerService);
