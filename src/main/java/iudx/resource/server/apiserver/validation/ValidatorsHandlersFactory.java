...
public class ValidatorsHandlersFactory {
  ...
  public List<Validator> build(
    ...
    switch (requestType) {
      ...
      case LATEST:
        ...
        break;
      case POST_TEMPORAL:
        validator = getPostEntitiesValidations(vertx, parameters, body, requestType, headers);
        break;
      case POST_ENTITIES:
        validator = getPostTemporalValidations(vertx, parameters, body, requestType, headers);
        break;
      case SUBSCRIPTION:
        validator = getSubscriptionsValidations(vertx, body, headers, parameters);
        break;
      case ASYNC_SEARCH:
  ...
  private List<Validator> getEntityRequestValidations(final MultiMap parameters, MultiMap headers) {
    List<Validator> validators = new ArrayList<>();
  ...
  private List<Validator> getTemporalRequestValidations(final MultiMap parameters, MultiMap headers) {
  ...
  private List<Validator> getLatestRequestValidations(final MultiMap parameters, MultiMap headers) {
  ...
  private List<Validator> getPostEntitiesValidations(
      ...
      final MultiMap parameters,
      final JsonObject body,
      final RequestType requestType, MultiMap headers) {
  ...
  private List<Validator> getSubscriptionsValidations(
      final Vertx vertx, final JsonObject body, final MultiMap headers, MultiMap parameters) {
    List<Validator> validators = new ArrayList<>();
  ...
  private List<Validator> getAsyncRequestValidations(final MultiMap parameters, MultiMap headers) {
  ...
  private List<Validator> getAsyncStatusRequestValidator(final MultiMap parameters, MultiMap headers) {
    List<Validator> validators = new ArrayList<>();
