...
public class SubscriberDetails {
    ...
    public void fromJson(JsonObject json) {
        ...
        Object catItemRaw = json.getValue("catitem");

        if (catItemRaw instanceof JsonObject) {
            this.catItem = (JsonObject) catItemRaw;
        } else if (catItemRaw instanceof String) {
            try {
                this.catItem = new JsonObject((String) catItemRaw);
            } catch (Exception e) {
                this.catItem = new JsonObject();
            }
        } else {
            this.catItem = new JsonObject();
        }
