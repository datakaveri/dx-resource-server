...
import static org.cdpg.dx.rs.listners.util.Constans.UNIQUE_ATTR_Q;
...
import org.cdpg.dx.rs.listners.util.BroadcastEventType;
...
public class UniqueAttribQlistener {
  ...
  public Future<Void> start() {
    ...
    dataBrokerService
        .basicConsumeInternal(UNIQUE_ATTR_Q, options)
        .onSuccess(
            uniqueHandler -> {
