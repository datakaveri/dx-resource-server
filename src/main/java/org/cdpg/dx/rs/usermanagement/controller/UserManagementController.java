...
public class UserManagementController implements ApiController {
    ...
    public UserManagementController(DataBrokerService dataBrokerService, RevokedService revokedService) {
        this.userManagementService = new UserManagementServiceImpl(dataBrokerService);
    ...
    private void handleResetPassword(RoutingContext routingContext) {
        ...
        userManagementService.resetPassword(userid).onSuccess(successHandler -> {
