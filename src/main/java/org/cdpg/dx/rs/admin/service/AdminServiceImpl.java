...
import static iudx.resource.server.apiserver.admin.util.Constants.UNIQUE_ATTR_EX;
import static iudx.resource.server.apiserver.admin.util.Constants.UNIQUE_ATTR_EX_ROUTING_KEY;
...
public class AdminServiceImpl implements AdminService {
  ...
  private static SelectQuery selectRevokedTokenQuery(String userId) {
    ConditionComponent conditionComponent =
        new Condition("_id", Condition.Operator.EQUALS, List.of(userId));
    return new SelectQuery(
        "revoked_tokens", List.of("*"), conditionComponent, null, null, null, null);
  }
  ...
  public Future<Void> updateUniqueAttribute(String id, String attribute) {
    Promise<Void> promise = Promise.promise();
    ConditionComponent conditionComponent =
        new Condition("resource_id", Condition.Operator.EQUALS, List.of(id));
  ...
  public Future<Void> deleteUniqueAttribute(String id) {
    ...
    ConditionComponent conditionComponent =
        new Condition("resource_id", Condition.Operator.EQUALS, List.of(id));
    DeleteQuery deleteQuery = new DeleteQuery("unique_attributes", conditionComponent, null, null);
    postgresService
        .delete(deleteQuery)
        .compose(
            pgHandler -> {
