...
public class AdminController implements ApiController {
    ...
    public AdminController (PostgresService postgresService, DataBrokerService dataBrokerService, RevokedService revokedService){
        this.adminService=new AdminServiceImpl(postgresService,dataBrokerService);
    ...
    private void handlerRevokedTokenRequest (RoutingContext routingContext){
        ...
        adminService.revokedTokenRequest(userid).onSuccess(successHandler->{
    ...
    private void handleCreateUniqueAttribute (RoutingContext routingContext){
        ...
        adminService.createUniqueAttribute(userid, attribute).onSuccess(successHandler->{
            // handle success handler
    ...
    private void handleUpdateUniqueAttribute (RoutingContext routingContext){
        ...
        adminService.updateUniqueAttribute(userid, attribute).onSuccess(successHandler->{
            // handle success handler
    ...
    private void handleDeleteUniqueAttribute (RoutingContext routingContext){
        ...
        adminService.deleteUniqueAttribute(userId).onSuccess(successHandler->{
            // handle success handler
